...
alias bfzfh='fd . -u | fzf --preview="batcat --color=always {}"'
alias bfzfwh='fd . -u | fzf --preview="batcat --color=always {}" --preview-window=wrap'
...
alias ourl='~/Tools/Custom/Bash/lists/ourl.sh'
alias ofile='~/Tools/Custom/Bash/lists/ofile.sh'
alias echooneliner='~/Tools/Custom/Bash/lists/echooneliner.sh'
alias claer='clear'
alias celar='clear'
alias clera='clear'
alias caler='clear'
...
alias rtl='~/Tools/Custom/Bash/symbols_and_characters/remove_top_line.sh'
alias rbl='~/Tools/Custom/Bash/symbols_and_characters/remove_bottom_line.sh'
...
alias sploitus="~/Tools/Custom/Bash/web/sploitus.sh"
alias exploit-notes="~/Tools/Custom/Bash/web/exploit-notes.sh"
alias juggernaut-sec="~/Tools/Custom/Bash/web/juggernaut-sec.sh"
alias redteamnotes="~/Tools/Custom/Bash/web/redteamnotes.sh"
alias redteamnotes2="~/Tools/Custom/Bash/web/redteamnotes2.sh"
alias pentesteverything="~/Tools/Custom/Bash/web/pentesteverything.sh"
alias windows-privileges-web="~/Tools/Custom/Bash/web/windows-privileges-web.sh"
alias sddlparser="~/Tools/Custom/Bash/web/sddlparser.sh"
alias wiki-nxc="~/Tools/Custom/Bash/web/wiki-nxc.sh"
alias 0xdf="~/Tools/Custom/Bash/web/0xdf.sh"
alias ippsec="~/Tools/Custom/Bash/web/ippsec.sh"
alias examplehashes="~/Tools/Custom/Bash/web/examplehashes.sh"
alias crackstation="~/Tools/Custom/Bash/web/crackstation.sh"
alias virustotal="~/Tools/Custom/Bash/web/virustotal.sh"
alias github="~/Tools/Custom/Bash/web/github.sh"
alias youtube="~/Tools/Custom/Bash/web/youtube.sh"
...
alias gencodeblock="~/Tools/Custom/Bash/note_generator/gencodeblock.sh"
alias snmap="~/Tools/Custom/Bash/note_generator/snmap.sh"
alias severity="~/Tools/Custom/Bash/note_generator/severity.sh"
alias rrdfip="~/Tools/Custom/Bash/modify/replace_and_rename.sh"
alias rrdfsip="~/Tools/Custom/Bash/modify/replace_and_rename_single.sh"
alias mtmux="~/Tools/Custom/Bash/tmux_sessions/mtmux.sh"
alias mtwindows="~/Tools/Custom/Bash/tmux_sessions/mtwindows.sh"
...
alias snip="~/Tools/Custom/Bash/window_manager/snip.sh"
alias bhrc="~/Tools/Custom/Bash/bh_tools/bhrc.sh"
alias bh="~/Tools/Custom/Bash/bh_tools/bh.sh"
alias bhe="~/Tools/Custom/Bash/bh_tools/bhe.sh"
alias bhu="~/Tools/Custom/Bash/bh_tools/bhu.sh"
alias bhpi="~/Tools/Custom/Bash/bh_tools/bhpi.sh"
alias bhp="~/Tools/Custom/Bash/bh_tools/bhp.sh"
alias bhdc="~/Tools/Custom/Bash/bh_tools/bhdc.sh"
alias bhfi="~/Tools/Custom/Bash/bh_tools/bhfi.sh"
alias bhjs="~/Tools/Custom/Bash/bh_tools/bhjs.sh"
alias bhmp="~/Tools/Custom/Bash/bh_tools/bhmp.sh"
alias bhtn="~/Tools/Custom/Bash/bh_tools/bhtn.sh"
alias bhsc="~/Tools/Custom/Bash/bh_tools/bhsc.sh"
alias urljs="~/Tools/Custom/Bash/javascript/urljs.sh"
